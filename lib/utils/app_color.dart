...
class AppColor{
  // static const red_bg = Color(0xFFEFC5C5);
  static const darkGrey = Color(0xFF7B7B7B);
  static const black = Color(0xFF313131);
  static const darkBlack = Color(0xFF1F1F1F);
  static const lightOrange = Color(0xFFffd9b3);
  static const lightGreen = Color(0xFFb3ff66);
  static const lightYellow = Color(0xFFffff66);
  static const lightPink = Color(0xFFF7CAC9);
  static const greenAsh = Color(0xFFA0DAA9);
  static const lightBlue = Color(0xFF99ccff);
  static const greyDivider = Color(0xFF707070);
  static const white = Color(0xFFFFFFFF);
  static const darkMaroon = Color(0xFF660000);
  static const splashDarkMaroon = Color(0xFF6D0616);
